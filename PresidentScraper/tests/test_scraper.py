...
class ScraperTest(unittest.TestCase):
    ...
    def test_scrapeShouldParseTheCorrectNumberOfPresidents(self):
        ...
        self.assertEqual(result[1].portrait.online_uri, "//upload.wikimedia.org/wikipedia/commons/thumb/c/c8/John_Adams_1800_to_1815_Portrait_%284x5_cropped%29.jpg/110px-John_Adams_1800_to_1815_Portrait_%284x5_cropped%29.jpg")
        self.assertEqual(result[1].president.name, "John Adams")
        self.assertEqual(result[1].president.birth_date, "1735")
        self.assertEqual(result[1].president.death_date, "1826")
        self.assertEqual(result[1].start_date, "March 4, 1797")
        self.assertEqual(result[1].end_date, "March 4, 1801")
        self.assertEqual(len(result[1].political_affiliations), 1)
        self.assertEqual(result[1].political_affiliations[0], "Federalist")
        self.assertEqual(len(result[1].election_years), 1)
        self.assertEqual(result[1].election_years[0], "1796")
        self.assertEqual(len(result[1].vice_presidents), 1)
        self.assertEqual(result[1].vice_presidents[0], "Thomas Jefferson")
